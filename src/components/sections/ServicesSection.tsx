...
const ServicesSection = () => {
    return (
        <section id="servicios" className="w-full bg-white pt-8 py-15 px-3.5 md:px-5 lg:px-16">
            ...
            <article className="gap-6 grid grid-cols-1 mt-8 pt-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <p className="text-text-secondary text-sm leading-relaxed mb-4 md:text-lg">Creamos páginas web profesionales para que tu negocio tenga presencia en internet y más clientes puedan encontrarte.</p>
                ...
                <article className="group p-8 duration-300 border border-slate-100 bg-slate-50 rounded-2xl transition-all hover:bg-white hover:shadow-xl hover:translate-y-2">
                    ...
                    <p className="text-text-secondary text-sm leading-relaxed mb-4 md:text-lg">Automatizamos tareas repetitivas para que tu negocio ahorre tiempo y reduzca errores.</p>
                    <ul className="space-y-2 text-sm font-medium text-text-footer-primary">
                        <li className="flex items-center gap-2">
                            <span className="text-[10px] bg-btn-primary p-0.5 text-white rounded-full"><FaCheck /></span>
                ...
                {/* Optimización de las web */}
                <article className="group p-8 duration-300 border border-slate-100 bg-slate-50 rounded-2xl transition-all hover:bg-white hover:shadow-xl hover:translate-y-2">
                    {/* Icon */}
                    <div className="w-12 h-12 rounded-lg bg-btn-primary/10 text-btn-primary flex items-center justify-center mb-6 group-hover:bg-btn-primary group-hover:text-white transition-colors">
                        <span><IoMdSettings className="text-3xl" /></span>
                    </div>
                    <h3 className="text-text-primary text-xl font-bold mb-3 md:text-2xl">Optimización de Páginas Web</h3>
                    <p className="text-text-secondary text-sm leading-relaxed mb-4 md:text-lg">Mejoramos páginas web existentes para que carguen más rápido, se vean más profesionales y funcionen correctamente en celulares y computadores.</p>
                    <ul className="space-y-2 text-sm font-medium text-text-footer-primary">
                        <li className="flex items-center gap-2">
                            <span className="text-[10px] bg-btn-primary p-0.5 text-white rounded-full"><FaCheck /></span>
