...
const TermsPage = () => {
    return (
        <>
            <SEO title="Términos y Condiciones — LineaSoftTech" />
            <article className="pt-24 pb-16 px-6 min-h-screen bg-white max-w-3xl mx-auto">
                ...
                <div className="space-y-6 text-text-secondary">
                    ...
                    <section>
                        ...
                        <p>
                            LineaSoftTech no será responsable por ningún daño directo, indirecto, incidental o consecuente que resulte del uso de este sitio web o de la información contenida en él. Los servicios que mostramos son ejemplos de nuestro trabajo y pueden variar según los requisitos específicos de cada proyecto.
                        </p>
                    </section>
