...
export const projects: Project[] = [
    {
        ...
        status: "pilot",
        description: "Actualmente en fase de prueba piloto en un comercio local de la región.",
    ...
    },
    {
        ...
        status: "portfolio",
        description: "Aplicación demo de gestión de gimnasios con React y Django. Demuestra roles de Admin y Usuario y gestión de miembros como proyecto demostrativo de capacidad técnica.",
        ...
        gallery: [
            "/assets/projects/gallery/controlFit/demo-Home.jpg",
            "/assets/projects/gallery/controlFit/demo-Listar.jpg",
            "/assets/projects/gallery/controlFit/demo-Usuario.jpg"
        ]
    },
    {
        id: 3,
        ...
        status: "portfolio",
        description: "Refactorización demo de una plataforma educativa migrando de JavaScript vanilla a React con TypeScript, demostrando mejora de arquitectura y escalabilidad.",
        ...
        gallery: [
            "/assets/projects/gallery/instituciones/demo-Home.jpg",
            "/assets/projects/gallery/instituciones/demo-Listar.jpg",
            "/assets/projects/gallery/instituciones/demo-Profile.jpg"
        ]
    },
    {
        id: 4,
        ...
        status: "portfolio",
        description: "Landing page demo para servicios de estampados personalizados, demostrando diseño responsivo y optimización de rendimiento.",
